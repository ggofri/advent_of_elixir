# 🎄 Advent of Code 2015-2024 in Elixir
...
│   │   │   └── challenge_2.ex
│   │   ├── test/
│   │   │   └── challenge_1_test.exs
│   │   │   └── challenge_2_test.exs
│   │   └── input.txt
│   ├── year_2016/
│   ├── ...
├── tests/
...
│   ├── year_2015/
│   │   ├── day_01/
│   │   │   └── challenge_1_sample_input.txt
│   │   │   └── challenge_2_sample_input.txt
│   │   │   └── challenge_1_final_input.txt
│   │   │   └── challenge_2_final_input.txt
├── scripts/
│   └── setup_day.ex
└── README.md
```
...
### Setup
```bash
git clone https://github.com/julignacio/advent-of-elixir
cd advent-of-elixir
```
...
mix run -e "Day01.Challenge01.solve()"
```

## 📚 Learning Resources

Throughout this journey, I'm using these resources to learn Elixir:
